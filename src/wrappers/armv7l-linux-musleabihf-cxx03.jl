# Autogenerated wrapper script for Geant4_jll for armv7l-linux-musleabihf-cxx03
...
JLLWrappers.@declare_library_product(libG4Persistency, "libG4persistency.so")
...
JLLWrappers.@declare_library_product(libG4VisXXX, "libG4visXXX.so")
