...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Geant4_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("872b6946-528a-5ac7-9145-d37eec569368"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Geant4", artifacts_toml) for e in artifacts["Geant4"]]
...
if best_platform === nothing
    @debug("Unable to load Geant4; unsupported platform $(triplet(platform_key_abi()))")
else
